        ...
        <div class="info-table1"
            ...
            line-height: 18px;"
                ...
                <tr>
                    ...
                    <td style="border: 1px solid #727171; padding-left:10px; padding-left:10px;"></td>
                    <td style="border: 1px solid #727171; padding-left:10px; padding-left:10px;">-</td>
                    <td style="border: 1px solid #727171; padding-left:10px; padding-left:10px;">{{ $pengeluaran[9] }}</td>
                </tr>
            </table>
        </div>
                    ...
                    <tr>
                        <td colspan="2" rowspan="4">
                            <div class="payment-text" style="margin-left: 10px; margin-top: 20px">
                                {{ $pengeluaran[2] }} <br>
                                NAMA BANK: {{ $pengeluaran[7] }} <br>
                                NOMOR AKUN BANK :{{ $pengeluaran[10] }} <br>
