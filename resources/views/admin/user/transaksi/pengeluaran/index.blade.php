@extends('layouts.app', [
    'title' => 'Pembelian',
    'breadcrumbs' => ['Transaksi', 'Pembelian'],
])
@section('content')
    <div class="card">
        <div class="card-content">
            <div class="card-body">
                <a href="{{ route('transaksi.create') }}" class="btn btn-primary waves-effect waves-light"><i
                        class="fa fa-plus"></i> Pembelian</a>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="header-container"
                            ...
                            <b class="modal-title" style="font-size: 20px;">Data Pembelian</b>
                            @if ($t->status == 'Success')
                                <div>
                                    <a href="{{ route('data.pengeluaran', ['id_trans' => $t->id]) }}"
                                        class="btn btn-lg btn-print" style="margin-right: 1px;" target="_blank">
                                        <i class="feather icon-printer"><br><small>Faktur</small></i></a>
                                    <a href="{{ route('invoice.transaksi', ['id' => $t->id]) }}"
                        ...
                        <div class="content-body" style="width: 100%; min-height: 600px; border: 1px solid #080707; overflow: auto; ">
                            ...
                            {{-- detail informasi --}}
                            <div class="detail-content" style="display: flex; width:100%; padding: 10px 0;">
                                {{-- informasi alamat --}}
                            ...
                            <div class="info-table1"
                                style="width: 100%; padding-left: 10px; padding-right: 10px; margin-top:20px; padding-bottom: 15px;">
                                <table border="0"
                                ...
                                line-height: 18px;">
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #727171; padding-left:10px;">@currency($t->hasManyTransaksi->sum('total'))
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #727171; padding-left:10px;">
                                                <b>@currency($t->hasManyTransaksi->sum('total'))</b>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2"></td>
